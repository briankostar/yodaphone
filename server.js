...
app.post('/api/v1', function(req, res, next){
  ...
  //var message_to_pass = req.body.message.replace(/ /g, '_');

  //make request w message_to_pass w API key and get response back..
  unirest.get("https://yoda.p.mashape.com/yoda?sentence=You+will+learn+how+to+speak+like+master+someday.")
